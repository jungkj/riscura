...
export const ControlCreateSchema = z.object({
  ...
  effectiveness: z.union([z.enum(['LOW', 'MEDIUM', 'HIGH']), z.number().min(0).max(100)]),
  owner: z.string().uuid().optional(),
...
export const ControlFilterSchema = z.object({
  ...
  frequency: z
    .enum(['CONTINUOUS', 'DAILY', 'WEEKLY', 'MONTHLY', 'QUARTERLY', 'ANNUALLY', 'AD_HOC'])
    .optional(),
  effectiveness: z
    .union([
...
export const AssessmentCreateSchema = z.object({
  ...
  riskCategories: z
    .array(z.enum(['OPERATIONAL', 'FINANCIAL', 'STRATEGIC', 'COMPLIANCE', 'TECHNOLOGY']))
    .optional(),
