...
export class DatabaseOptimizer {
  ...
  private recordMetrics(
    ...
    existing.averageDuration = existing.totalDuration / (existing.totalExecutions - existing.cacheHits);
  ...
  async healthCheck(): Promise<DatabaseHealthCheck> {
    try {
      ...
      return {
        healthy: false,
        latency: -1,
        connectionStats: { total_connections: 0, active_connections: 0, idle_connections: 0, idle_in_transaction: 0 },
