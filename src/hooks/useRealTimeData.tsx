...
export function useRealTimeData(_options: UseRealTimeDataOptions) {
  ...
  const callbacks: RealTimeCallbacks = {
    ...
    onControlChange: useCallback(
      (payload: RealtimePostgresChangesPayload<Control>) => {
  ...
  const subscribe = useCallback(() => {
    ...
    subscriptionRef.current = serviceRef.current.subscribeToOrganization(organizationId, callbacks);
