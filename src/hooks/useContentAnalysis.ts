      ...
      try {
        ...
        switch (action) {
          case 'explain': {
            ...
            confidence =
              typeof explanation === 'object' && explanation && 'confidence' in explanation
                ? (explanation.confidence as number)
                : 0.8;
            alternatives =
              typeof explanation === 'object' && explanation && 'relatedConcepts' in explanation
