  ...
  const aiFeatures = [
    {
      ...
      description:
        'Leverage machine learning to identify patterns and predict potential risks before they become critical issues.',
    },
    {
      icon: Zap,
      title: 'Automated Evidence Collection',
      description:
        'Automatically gather and organize evidence from multiple sources, reducing manual effort by 80%.',
    },
    {
      icon: Target,
      title: 'Smart Risk Prioritization',
      description:
        'AI algorithms analyze risk factors to help you focus on what matters most to your organization.',
    },
  ];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            Riscura AI transforms how organizations approach risk management with predictive
