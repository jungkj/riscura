...
export const DaisyAlertDialogTrigger: React.FC<{ children: React.ReactNode; asChild?: boolean }> = ({ children }) => {
  return <>{children}</>;
};

export const AlertDialogTrigger = DaisyAlertDialogTrigger;

export const DaisyAlertDialogContent: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className }) => {
  return (
...
export const DaisyAlertDialogHeader: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className }) => {
  return (
...
export const DaisyAlertDialogTitle: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className }) => {
  return (
...
export const DaisyAlertDialogDescription: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className }) => {
  return (
    <p className={cn('text-sm opacity-70 mt-2', className)}>
      {children}
    </p>
  );
};
...
export const DaisyAlertDialogFooter: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className }) => {
  return (
...
export const DaisyAlertDialogAction: React.FC<React.ButtonHTMLAttributes<HTMLButtonElement>> = ({ children, className, ...props }) => {
  return (
...
export const DaisyAlertDialogCancel: React.FC<React.ButtonHTMLAttributes<HTMLButtonElement>> = ({ children, className, ...props }) => {
  return (
