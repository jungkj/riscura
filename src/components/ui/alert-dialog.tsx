...
>(({ className, ...props }, ref) => (
  <DaisyAlertDialogPrimitive.Action
    ...
    className={cn(
      ...
      'bg-[#191919] text-[#FAFAFA] hover:bg-[#191919]/90',
      'focus:outline-none focus:ring-2 focus:ring-[#191919] focus:ring-offset-2 focus:ring-offset-[#FAFAFA]',
...
>(({ className, ...props }, ref) => (
  <DaisyAlertDialogPrimitive.Cancel
    ...
    className={cn(
      'inline-flex items-center justify-center rounded-lg px-6 py-3 text-sm font-semibold',
      'border border-[#D8C3A5]/60 bg-transparent text-[#A8A8A8]',
      'hover:bg-[#F5F1E9] hover:text-[#191919] hover:border-[#D8C3A5]',
