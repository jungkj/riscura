...
import { getHeadingClasses, getBodyClasses, getCaptionClasses, spacing, separators, backgrounds } from '@/lib/design-system/typography';
        ...
        >
          ...
          <div className="space-y-1">
            <div className="flex items-baseline gap-2">
              ...
              <EnhancedCaption variant="label">
                {stat.label}
              </EnhancedCaption>
            </div>
            {stat.description && (
              <EnhancedCaption variant="muted">
                {stat.description}
              </EnhancedCaption>
            )}
          </div>
