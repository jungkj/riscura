...
export const RiskMatrixStep = ({ onNext, onBack }: RiskMatrixStepProps) => {
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="font-medium">
                    {likelihoodLabels[riskData.likelihood - 1]} ({riskData.likelihood}/5)
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {impactLabels[riskData.impact - 1]} ({riskData.impact}/5)
                  </p>
                </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm text-blue-900">
                  ...
                  <ul className="space-y-1 text-xs">
                    <li>
                      • <strong>Likelihood:</strong> How probable is this risk?
                    </li>
                    <li>
                      • <strong>Impact:</strong> How severe would the consequences be?
                    </li>
                  </ul>
                </div>
              </div>
