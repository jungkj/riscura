                  ...
                  {settings.alertSettings.quietHours.enabled && (
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <DaisyLabel>Start Time</DaisySwitch>
                        <DaisyInput
                          type="time"
...
updateSettings('monitoring.enableRealTimeMonitoring', checked)} />
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <DaisyLabel>Anomaly Detection</DaisySwitch>
...
updateSettings('monitoring.enableAnomalyDetection', checked)} />
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <DaisyLabel>Behavior Analysis</DaisySwitch>
...
<div className="space-y-4">
                ...
                <div className="space-y-4">
                  <DaisyLabel>Data Retention: {settings.monitoring.retentionPeriod} days</DaisySlider>
                  <DaisySlider
                ...
                <div className="space-y-4">
                  <DaisyLabel>Monitored Categories</DaisySlider>
...
updateSettings('accessControl.enforceStrongPasswords', checked)} />
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <DaisyLabel>Multi-Factor Authentication</DaisySwitch>
...
updateSettings('accessControl.sessionTimeout', parseInt(e.target.value))}
                  ...
                  <div className="space-y-2">
                    <DaisyLabel>Max Failed Attempts</DaisyInput>
                    <DaisyInput
                      type="number"
...
updateSettings('accessControl.maxFailedAttempts', parseInt(e.target.value))}
                  ...
                  <div className="space-y-2">
                    <DaisyLabel>Lockout Duration (minutes)</DaisyInput>
                    <DaisyInput
                      type="number"
...
updateSettings('accessControl.lockoutDuration', parseInt(e.target.value))}
                ...
                <div className="space-y-2">
                  <DaisyLabel>Allowed IP Ranges</DaisyInput>
                  <DaisyTextarea
...
updateSettings('compliance.enableComplianceMonitoring', checked)} />
                ...
                <div className="space-y-4">
                  <DaisyLabel>Compliance Frameworks</DaisySwitch>
...
updateSettings('compliance.autoReporting', checked)} />
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <DaisyLabel>Audit Logging</DaisySwitch>
...
updateSettings('compliance.enableAuditLogging', checked)} />
                ...
                {settings.compliance.autoReporting && (
                  <div className="space-y-2">
                    <DaisyLabel>Reporting Frequency</DaisySwitch>
                    <DaisySelect
...
updateSettings('integrations.enableSIEMIntegration', checked)} />
                  ...
                  {settings.integrations.enableSIEMIntegration && (
                    <div className="space-y-2">
                      <DaisyLabel>SIEM Endpoint URL</DaisySwitch>
                      <DaisyInput
...
updateSettings('integrations.enableAPILogging', checked)} />
                ...
                <div className="space-y-2">
                  <DaisyLabel>Webhook URL</DaisySwitch>
                  <DaisyInput
...
updateSettings('integrations.webhookUrl', e.target.value)} />
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <DaisyLabel>Third-party Scanning</DaisyInput>
