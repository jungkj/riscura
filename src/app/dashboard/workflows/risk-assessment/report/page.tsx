    ...
    try {
      ...
      if (risksResponse.ok && controlsResponse.ok) {
        ...
        setStats({
          ...
          highRisks: risks.filter((r: any) => r.riskScore === 'high' || r.riskScore === 'critical')
            .length,
              ...
              <DaisyCardBody className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">{loading ? '...' : stats.totalRisks}</p>
                  </div>
              ...
              <DaisyCardBody className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">{loading ? '...' : stats.totalControls}</p>
                  </div>
              ...
              <DaisyCardBody className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">{loading ? '...' : stats.openActions}</p>
                  </div>
                ...
                <DaisyCardBody>
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="p-3 bg-gray-50 rounded">
                      ...
                      <p className="text-gray-600">
                        {
                          Object.entries(reportConfig.sections).filter(([_, enabled]) => enabled)
                            .length
                        }{' '}
                        of {Object.keys(reportConfig.sections).length} sections
                      </p>
                    </div>
              ...
              <DaisyCard>
                ...
                <DaisyCardBody className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    <DaisyButton variant="outline" className="flex-1" onClick={handleSendReport}>
                      <Send className="h-4 w-4 mr-2" />
                      Send
                    </DaisyButton>
                  </div>

                  <DaisyButton variant="outline" className="w-full" onClick={() => window.print()}>
