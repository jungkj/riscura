      ...
      <div className="space-y-4">
        ...
        <div className="p-4 bg-yellow-100 rounded">
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              <a href="/api/auth/debug-session" className="text-blue-600 hover:underline">
                Auth Debug Session
              </a>
            </li>
            <li>
              <a href="/api/google-oauth/debug" className="text-blue-600 hover:underline">
                OAuth Debug
              </a>
            </li>
            <li>
              <a href="/api/google-oauth/session" className="text-blue-600 hover:underline">
                OAuth Session API
              </a>
            </li>
            <li>
              <a href="/dashboard" className="text-blue-600 hover:underline">
                Regular Dashboard (with ProtectedRoute)
              </a>
            </li>
          </ul>
        </div>
