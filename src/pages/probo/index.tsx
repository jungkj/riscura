...
export default function ProboIntegrationPage() {
  ...
  useEffect(() => {
    ...
    if (tab && ['overview', 'dashboard', 'vendor-assessment', 'soc2', 'controls'].includes(tab) && tab !== activeTab) {
      setActiveTab(tab);
    }
  ...
  const integrationFeatures = [
    {
      ...
      description: 'Automatically assess vendor security posture using advanced AI agents with real-time analysis',
      icon: <Building className="h-7 w-7" />,
      gradient: 'from-blue-500 to-cyan-500',
      stats: '24 vendors assessed',
      progress: 85,
      benefits: ['Real-time risk scoring', 'Automated compliance checks', 'Evidence collection', 'Risk mitigation recommendations']
    },
    {
      title: 'SOC 2 Framework Integration',
      description: 'Complete SOC 2 compliance workflow with pre-built controls and automated evidence collection',
    ...
    },
    {
      ...
      stats: '650+ controls',
      progress: 92,
      benefits: ['ISO 27001, NIST, SOC 2', 'Implementation guidance', 'Control mapping', 'Automated testing']
    },
    {
      title: 'Compliance Monitoring',
      description: 'Real-time compliance status tracking with automated reporting and trend analysis',
      icon: <BarChart3 className="h-7 w-7" />,
      gradient: 'from-orange-500 to-red-500',
      stats: '85% compliance score',
      progress: 85,
      benefits: ['Multi-framework support', 'Automated reporting', 'Trend analysis', 'Risk dashboard']
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#FAFAFA] via-white to-[#F8F9FA]">
       ...
       >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center space-x-3">
              <Button variant="outline" className="border-[#D8C3A5] hover:bg-[#199BEC]/5">
                <ExternalLink className="h-4 w-4 mr-2" />
                Documentation
              </Button>
              <Button className="bg-gradient-to-r from-[#199BEC] to-cyan-500 hover:from-[#199BEC]/90 hover:to-cyan-500/90 shadow-lg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs value={activeTab} onValueChange={handleTabChange}>
           ...
           >
            <TabsList className="grid w-full grid-cols-5 mb-8 bg-white/50 backdrop-blur-sm border border-[#D8C3A5]/30 p-1 rounded-xl">
              ...
              <TabsTrigger value="vendor-assessment" className="data-[state=active]:bg-white data-[state=active]:shadow-md">
                <Building className="h-4 w-4 mr-2" />
                Vendors
              </TabsTrigger>
              <TabsTrigger value="soc2" className="data-[state=active]:bg-white data-[state=active]:shadow-md">
                <Shield className="h-4 w-4 mr-2" />
                SOC 2
              </TabsTrigger>
              <TabsTrigger value="controls" className="data-[state=active]:bg-white data-[state=active]:shadow-md">
              ...
              >
                ...
                <motion.div variants={itemVariants} className="text-center space-y-6 py-12">
                  <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-[#199BEC]/10 to-cyan-500/10 rounded-full border border-[#199BEC]/20">
                    ...
                    <span className="text-sm font-medium text-[#199BEC]">Industry-Leading Integration</span>
                  </div>
                  <h2 className="text-5xl font-bold text-[#191919] leading-tight">
                    Transform Risk Management with
                    <span className="bg-gradient-to-r from-[#199BEC] to-cyan-500 bg-clip-text text-transparent"> AI Power</span>
                  </h2>
                  <p className="text-xl text-[#A8A8A8] max-w-4xl mx-auto leading-relaxed">
                    Streamline vendor assessments, automate compliance workflows, and access 650+ security controls 
                    with our comprehensive AI-powered risk management platform.
                  </p>
                ...
                <motion.div variants={itemVariants}>
                  <h3 className="text-2xl font-bold text-[#191919] mb-6 text-center">Quick Start Actions</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {quickActions.map((action, index) => (
                      ...
                      >
                        <Card className="bg-white/80 backdrop-blur-sm border-[#D8C3A5]/30 hover:shadow-xl transition-all duration-300 overflow-hidden group">
                ...
                <motion.div variants={itemVariants}>
                  <h3 className="text-2xl font-bold text-[#191919] mb-6 text-center">Platform Capabilities</h3>
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {integrationFeatures.map((feature, index) => (
                      <motion.div
                        ...
                        className="group"
                      >
                        <Card className="bg-white/80 backdrop-blur-sm border-[#D8C3A5]/30 hover:shadow-xl transition-all duration-300 overflow-hidden">
                          <CardHeader className="pb-4">
                            <div className="flex items-start justify-between">
                              <div className="flex items-center space-x-4">
                                ...
                                <div className="flex-1">
                                  <CardTitle className="text-[#191919] text-xl mb-1">{feature.title}</CardTitle>
                            ...
                            <Progress value={feature.progress} className="mt-3" />
                          </CardHeader>
                          <CardContent>
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="grid grid-cols-1 gap-2">
                                {feature.benefits.map((benefit, idx) => (
                                  <div key={idx} className="flex items-center text-sm text-[#A8A8A8]">
                ...
                <motion.div variants={itemVariants}>
                  <Card className="bg-gradient-to-br from-white via-white to-[#199BEC]/5 border-[#D8C3A5]/30 shadow-xl">
                    <CardHeader className="text-center pb-8">
                      <CardTitle className="text-2xl text-[#191919] flex items-center justify-center gap-2">
                    ...
                    <CardContent>
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {successMetrics.map((metric, index) => (
                          ...
                          >
                            <div className={`inline-flex p-3 rounded-full bg-white shadow-md ${metric.color}`}>
                              {metric.icon}
                            </div>
                            ...
                            <div className="space-y-3">
                              <div className="space-y-1">
                                <div className="text-sm text-[#A8A8A8]">
                                  Before: <span className="text-red-600 font-medium">{metric.before}</span>
                                </div>
                              ...
                              <Badge className="bg-gradient-to-r from-[#199BEC] to-cyan-500 text-white font-medium">
                                {metric.improvement}
                              </Badge>
                            </div>
                          </motion.div>
               ...
               >
                <ProboIntegrationDashboard />
                         ...
                         <TabsContent value="vendor-assessment">
               <motion.div
                 initial={isLoaded ? { opacity: 0, y: 20 } : false}
                 animate={isLoaded ? { opacity: 1, y: 0 } : false}
                 exit={{ opacity: 0, y: -20 }}
