...
import { Calendar, Download, FileText, Filter, Plus, RefreshCw, Send } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Generate custom reports and analyze risk data.</p>
        </div>
            ...
            <DaisyCard className="lg:col-span-1">
              ...
              <DaisyCardBody className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <DaisySelect defaultValue={reportPeriod} onValueChange={setReportPeriod}>
                    <DaisySelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <label htmlFor="risk-summary" className="text-sm">
                        Risk Summary
                      </label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        defaultChecked
                      />
                      <label htmlFor="control-effectiveness" className="text-sm">
                        Control Effectiveness
                      </label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        defaultChecked
                      />
                      <label htmlFor="compliance-status" className="text-sm">
                        Compliance Status
                      </label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <input type="checkbox" id="risk-trends" className="rounded" defaultChecked />
                      <label htmlFor="risk-trends" className="text-sm">
                        Risk Trends
                      </label>
                    </div>
                    <div className="flex items-center space-x-2">
            ...
            <div className="flex gap-2">
              <DaisyDropdownMenu>
                ...
                <DaisyDropdownMenuContent align="end">
                  <DaisyDropdownMenuItem>Filter by Type</DaisyDropdownMenuItem>
            ...
            {savedReports.map((report) => (
              <DaisyCard key={report.id}>
                <DaisyCardBody className="pb-2">
                  ...
                  <DaisyCardDescription>{report.description}</DaisyCardDescription>
                  <div className="flex items-center gap-1 text-sm text-muted-foreground mt-2">
                    <Calendar className="h-4 w-4" />
                    <span>Created on {new Date(report.createdAt).toLocaleDateString()}</span>
                  </div>
              ...
              <DaisyTable>
                ...
                <DaisyTableBody>
                  <DaisyTableRow>
                    ...
                    <DaisyTableCell>
                      <div className="flex -space-x-2">
                        ...
                        <div className="w-6 h-6 rounded-full bg-yellow-500 flex items-center justify-center text-[10px] text-white">
                          +3
                        </div>
                      </div>
                    </DaisyTableCell>
                    ...
                    <DaisyTableCell>
                      <DaisyBadge className="bg-green-100 text-green-700 dark:bg-green-950 dark:text-green-300">
                        Active
                      </DaisyBadge>
                    </DaisyTableCell>
                  ...
                  <DaisyTableRow>
                    ...
                    <DaisyTableCell>
                      <div className="flex -space-x-2">
                        <div className="w-6 h-6 rounded-full bg-[#191919] flex items-center justify-center text-[10px] text-white">
                          MG
                        </div>
                        <div className="w-6 h-6 rounded-full bg-red-500 flex items-center justify-center text-[10px] text-white">
                          DL
                        </div>
                        <div className="w-6 h-6 rounded-full bg-blue-500 flex items-center justify-center text-[10px] text-white">
                          JS
                  ...
                  <DaisyTableRow>
                    ...
                    <DaisyTableCell>
                      <DaisyBadge className="bg-yellow-100 text-yellow-700 dark:bg-yellow-950 dark:text-yellow-300">
                        Paused
                      </DaisyBadge>
                    </DaisyTableCell>
                    <DaisyTableCell className="text-right">
